...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='scunet_color_15', help='scunet_color_15, scunet_color_25, scunet_color_50')
    parser.add_argument('--testset_name', type=str, default='real9', help='test set, bsd68 | set12')
    ...
    # ----------------------------------------
    L_path = os.path.join(args.testsets, args.testset_name) # L_path, for Low-quality CarIdentityData
    H_path = L_path                               # H_path, for High-quality CarIdentityData
    E_path = os.path.join(args.results, result_name)   # E_path, for Estimated CarIdentityData
    util.mkdir(E_path)

    if H_path == L_path:
        args.need_degradation = True
    logger_name = result_name
    utils_logger.logger_info(logger_name, log_path=os.path.join(E_path, logger_name + '.logs'))
