...
class Predictor(BasePredictor):
    def setup(self):
        ...
        self.model_paths = {
            ...
            "grayscale CarIdentityData-15": "model_zoo/scunet_gray_15.pth",
            "grayscale CarIdentityData-25": "model_zoo/scunet_gray_25.pth",
            "grayscale CarIdentityData-50": "model_zoo/scunet_gray_50.pth",
            "color CarIdentityData-15": "model_zoo/scunet_color_15.pth",
            "color CarIdentityData-25": "model_zoo/scunet_color_25.pth",
            "color CarIdentityData-50": "model_zoo/scunet_color_50.pth",
        }
        self.models = {}
    ...
    def predict(
        ...
        model_name: str = Input(
            choices=[
                ...
                "grayscale CarIdentityData-15",
                "grayscale CarIdentityData-25",
                "grayscale CarIdentityData-50",
                "color CarIdentityData-15",
                "color CarIdentityData-25",
                "color CarIdentityData-50",
            ],
            default="real image denoising",
            description="Choose a model. 15, 25 and 50 in grayscale CarIdentityData and color CarIdentityData correspond to the added "
